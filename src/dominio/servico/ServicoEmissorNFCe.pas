...
uses
  ...
  pcnEventoNFe, pcnConversaoNFe,   pcnProcNFe, funcoes, ACBrDFeSSL;
...
type
  ...
  private
    ...
    FParametros :TConfiguracoesNFCe;

  private
    procedure GerarNFCe(Venda :TVenda);
    procedure GerarIdentificacao(Configuracoes :TConfiguracoesNFCe;
                                 Venda :TVenda;
                                 NFCe :NotaFiscal);
    procedure GerarEmitente(Empresa :TPessoa;
                            NFCe :NotaFiscal);
  ...
  public
    constructor Create(Configuracoes :TConfiguracoesNFCe);
...
uses
  ...
  Cliente, MaskUtils, EspecificacaoMovimentosPorCodigoPedido;
...
constructor TServicoEmissorNFCe.Create(Configuracoes: TConfiguracoesNFCe);
begin
   ...
   FACBrNFe.Configuracoes.WebServices.UF                  := Configuracoes.Empresa.Endereco.Cidade.estado.sigla;
...
procedure TServicoEmissorNFCe.GerarEmitente(Empresa: TPessoa; NFCe: NotaFiscal);
begin
...
procedure TServicoEmissorNFCe.GerarIdentificacao(
  Configuracoes: TConfiguracoesNFCe; Venda: TVenda; NFCe: NotaFiscal);
begin
