...
procedure TRepositorioRetornoLoteNFe.SetCamposExcluidos(
...
begin
   ...
   Auditoria.AdicionaCampoExcluido('codigo_lote', IntToStr(Ret.CodigoLote));
   Auditoria.AdicionaCampoExcluido('status',      Ret.Status);
   Auditoria.AdicionaCampoExcluido('motivo',      Ret.Motivo);
   Auditoria.AdicionaCampoExcluido('recibo',      Ret.Recibo);
end;

procedure TRepositorioRetornoLoteNFe.SetCamposIncluidos(
  Auditoria: TAuditoria; Objeto: TObject);
var
  Ret :TRetornoLoteNFe;
begin
   ...
   Auditoria.AdicionaCampoIncluido('codigo_lote', IntToStr(Ret.CodigoLote));
   Auditoria.AdicionaCampoIncluido('status',      Ret.Status);
   Auditoria.AdicionaCampoIncluido('motivo',      Ret.Motivo);
   Auditoria.AdicionaCampoIncluido('recibo',      Ret.Recibo);
end;
