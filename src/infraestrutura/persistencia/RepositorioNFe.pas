...
procedure TRepositorioNFe.SetCamposExcluidos(Auditoria: TAuditoria;
  Objeto: TObject);
var
  NFe :TNFe;
begin
   ...
   Auditoria.AdicionaCampoExcluido('codigo_nota_fiscal', IntToStr(NFe.CodigoNotaFiscal));
   Auditoria.AdicionaCampoExcluido('chave_acesso',       NFe.ChaveAcesso);
end;

procedure TRepositorioNFe.SetCamposIncluidos(Auditoria: TAuditoria;
  Objeto: TObject);
var
  NFe :TNFe;
begin
   ...
   Auditoria.AdicionaCampoIncluido('codigo_nota_fiscal', IntToStr(NFe.CodigoNotaFiscal));
   Auditoria.AdicionaCampoIncluido('chave_acesso',       NFe.ChaveAcesso);
end;
