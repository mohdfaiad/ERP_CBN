...
function TRepositorioUsuario.SQLGetExiste(arrayDeCampos :array of string): String;
begin
  result := inherited;
...
begin
   result := 'update or insert into usuarios (codigo, nome, login, senha, cod_Perfil, bloqueado)'+
             '                        values (:codigo, :nome, :login, :senha, :cod_Perfil, :bloqueado)';
end;
