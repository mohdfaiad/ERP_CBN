...
procedure TRepositorioRetornoNFe.SetCamposExcluidos(Auditoria: TAuditoria;
  Objeto: TObject);
var
...
begin
   ...
   Auditoria.AdicionaCampoExcluido('codigo_nota_fiscal', IntToStr(RetornoNFe.CodigoNotaFiscal));
   Auditoria.AdicionaCampoExcluido('status',             RetornoNFe.Status);
   Auditoria.AdicionaCampoExcluido('motivo',             RetornoNFe.Motivo);
end;

procedure TRepositorioRetornoNFe.SetCamposIncluidos(Auditoria: TAuditoria;
  Objeto: TObject);
var
  RetornoNFe :TRetornoNFe;
begin
   ...
   Auditoria.AdicionaCampoIncluido('codigo_nota_fiscal', IntToStr(RetornoNFe.CodigoNotaFiscal));
   Auditoria.AdicionaCampoIncluido('status',             RetornoNFe.Status);
   Auditoria.AdicionaCampoIncluido('motivo',             RetornoNFe.Motivo);
end;
