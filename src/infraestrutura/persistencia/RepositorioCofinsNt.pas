...
procedure TRepositorioCofinsNt.SetCamposExcluidos(Auditoria: TAuditoria;
  Objeto: TObject);
var
  Obj :TCofinsNt;
begin
   ...
   Auditoria.AdicionaCampoExcluido('codigo_item', FloatToStr(Obj.CodigoItem));
end;

procedure TRepositorioCofinsNt.SetCamposIncluidos(Auditoria: TAuditoria;
  Objeto: TObject);
var
  Obj :TCofinsNt;
begin
   ...
   Auditoria.AdicionaCampoIncluido('codigo_item', FloatToStr(Obj.CodigoItem));
end;
