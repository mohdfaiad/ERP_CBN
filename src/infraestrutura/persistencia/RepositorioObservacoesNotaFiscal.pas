...
procedure TRepositorioObservacoesNotaFiscal.SetCamposExcluidos(
...
begin
   ...
   Auditoria.AdicionaCampoExcluido('codigo_nota_fiscal',   IntToStr(Obs.CodigoNotaFiscal));
   Auditoria.AdicionaCampoExcluido('observacoes',          Obs.Observacoes);
   Auditoria.AdicionaCampoExcluido('obs_ger_pelo_sistema', Obs.ObservacoesGeradasPeloSistema);
end;

procedure TRepositorioObservacoesNotaFiscal.SetCamposIncluidos(
  Auditoria: TAuditoria; Objeto: TObject);
var
  Obs :TObservacaoNotaFiscal;
begin
   ...
   Auditoria.AdicionaCampoIncluido('codigo_nota_fiscal',   IntToStr(Obs.CodigoNotaFiscal));
   Auditoria.AdicionaCampoIncluido('observacoes',          Obs.Observacoes);
   Auditoria.AdicionaCampoIncluido('obs_ger_pelo_sistema', Obs.ObservacoesGeradasPeloSistema);
end;
