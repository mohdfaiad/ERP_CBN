...
procedure TRepositorioIcmsSn101.SetCamposExcluidos(Auditoria: TAuditoria;
  Objeto: TObject);
var
  Obj :TIcmsSn101;
begin
   ...
   Auditoria.AdicionaCampoExcluido('aliquota_credito_sn', FloatToStr(Obj.AliquotaCreditoSN));
end;

procedure TRepositorioIcmsSn101.SetCamposIncluidos(Auditoria: TAuditoria;
  Objeto: TObject);
var
  Obj :TIcmsSn101;
begin
   ...
   Auditoria.AdicionaCampoIncluido('aliquota_credito_sn', FloatToStr(Obj.AliquotaCreditoSN));
end;
