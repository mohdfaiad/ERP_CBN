...
procedure TRepositorioIcms00.SetCamposExcluidos(Auditoria: TAuditoria;
  Objeto: TObject);
var
  Obj :TIcms00;
begin
   ...
   Auditoria.AdicionaCampoExcluido('codigo_item', IntToStr(Obj.CodigoItem));
   Auditoria.AdicionaCampoExcluido('origem', IntToStr(TTipoOrigemMercadoriaUtilitario.DeEnumeradoParaInteger(Obj.OrigemMercadoria)));
   Auditoria.AdicionaCampoExcluido('aliquota', FloatToStr(Obj.Aliquota));
   Auditoria.AdicionaCampoExcluido('perc_reducao_bc', FloatToStr(Obj.PercReducaoBC));
end;

procedure TRepositorioIcms00.SetCamposIncluidos(Auditoria: TAuditoria;
  Objeto: TObject);
var
  Obj :TIcms00;
begin
   ...
   Auditoria.AdicionaCampoIncluido('codigo_item', IntToStr(Obj.CodigoItem));
   Auditoria.AdicionaCampoIncluido('origem', IntToStr(TTipoOrigemMercadoriaUtilitario.DeEnumeradoParaInteger(Obj.OrigemMercadoria)));
   Auditoria.AdicionaCampoIncluido('aliquota', FloatToStr(Obj.Aliquota));
   Auditoria.AdicionaCampoIncluido('perc_reducao_bc', FloatToStr(Obj.PercReducaoBC));
end;
