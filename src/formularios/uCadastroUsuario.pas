...
uses
  ...
  Criptografia, Repositorio, Usuario, FireDAC.Comp.Client, ImgList,
  System.ImageList;
...
begin
  ...
  cds.Close;
  dsp.DataSet := FDM.GetConsulta('SELECT U.CODIGO, U.NOME, U.LOGIN, U.SENHA, U.COD_PERFIL,      '+
                                 'IIF(U.BLOQUEADO = ''S'',''S'',''N'') BLOQUEADO, P.NOME PERFIL '+
                                 '       FROM USUARIOS U                                        '+
