inherited frmRelatorioMaterias: TfrmRelatorioMaterias
  Left = 743
  Top = 450
  Caption = 'Relat'#243'rio de Entrada e Sa'#237'da de Mat'#233'rias'
  ClientHeight = 229
  ClientWidth = 550
  OnShow = FormShow
  ExplicitWidth = 566
  ...
  object RLReport1: TRLReport
    ...
    object RLBand1: TRLBand
      ...
      object RLLabel1: TRLLabel
        ...
        Caption = 'Relat'#243'rio de entradas e sa'#237'das de mat'#233'ria'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -21
        Font.Name = 'Arial'
  ...
  object qryMateria: TFDQuery
    ...
    SQL.Strings = (
      'select esm.*, m.descricao, m.estoque_fisico, m.unidade'
      'from entradas_saidas_materia esm'
      'inner join materias m on m.codigo = esm.codigo_materia'
      
        'where esm.data_movimento between :dti and :dtf and esm.codigo_ma' +
        'teria = :codmateria')
    Left = 336
    Top = 24
    ParamData = <
    ...
    object qryMateriaCODIGO_MATERIA: TIntegerField
      FieldName = 'CODIGO_MATERIA'
      Origin = 'CODIGO_MATERIA'
    end
    object qryMateriaQUANTIDADE: TBCDField
    ...
    object qryMateriaDATA_MOVIMENTO: TSQLTimeStampField
      FieldName = 'DATA_MOVIMENTO'
      Origin = 'DATA_MOVIMENTO'
    end
    object qryMateriaTIPO: TStringField
      FieldName = 'TIPO'
      Origin = 'TIPO'
      FixedChar = True
      Size = 1
