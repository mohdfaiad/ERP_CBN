...
uses
  ...
  Provider, DB, DBClient, ZAbstractRODataset, ZAbstractDataset, ZDataset;
...
procedure TfrmPesquisaSimples.DBGrid1TitleClick(Column: TColumn);
begin
//  TZQuery(ds.DataSet).IndexFieldNames := Column.FieldName;
end;
